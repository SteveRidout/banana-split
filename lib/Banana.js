		...
		async.waterfall([
			...
			function (result, experiment, callback) {
				if (!result) {
					...
					console.log('last calc: ', result.lastCalculated);
			...
			function (result, experiment, callback) {
				result.startDate = result.startDate || experiment._id.getTimestamp();
				...
				models.participant.find(query, function (err, participants) {
